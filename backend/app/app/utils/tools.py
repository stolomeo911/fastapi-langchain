...
load_dotenv('C:/Users\stefano\PycharmProjects/fastapi_langchain\.env')

pokemon_api_url = "https://pokeapi.co/api/v2/pokemon/"
unsplash_api_url = f"https://api.unsplash.com/search/photos?client_id={os.environ['UNSPLASH_API_KEY']}&query="
...
class ImageSearchTool(BaseTool):
    ...
    async def _arun(self, query: str, run_manager: Optional[Any] = None) -> str:
        """Use the tool asynchronously."""
        async with httpx.AsyncClient() as client:
            if os.environ['UNSPLASH_API_KEY'] == "":
...
class YoutubeSearchTool(BaseTool):
    ...
    async def _arun(self, query: str, run_manager: Optional[Any] = None) -> str:
        """Use the tool asynchronously."""
        async with httpx.AsyncClient() as client:
            if not os.environ['SERP_API_KEY'] or os.environ['SERP_API_KEY'] == "":
